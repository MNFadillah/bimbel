...
<script type="text/javascript">
  $('.openDialog').click(function (evt) {
    var kelas = $(this).attr("data-kelas");
      ...
      $.ajax({
          type: "POST",
          url: '<?php echo base_url();?>views/kelas/getKelasById.php',
          data: { id_kelas:kelas }, 
      ...
      $.ajax({
          type: "POST",
          url: '<?php echo base_url();?>views/mapel/getMapelById.php',
  ...
  $('#inputkelas').change(function (argument) {
    ...
    $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>views/mapel_per_kelas/getMapelForAddNotId.php',
