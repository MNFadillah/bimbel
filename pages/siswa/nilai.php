...
<script type="text/javascript">
	$('#btnSearch').click(function () {
		...
		$.ajax({
          type: "POST",
          url: '<?php echo base_url();?>pages/mapel_per_kelas/getMapelPerKelasForNilai.php',
          data: { id_kelas:kelas }, 
  ...
  function getNilai(data) {
    ...
    $.ajax({
      type: "POST",
      url:"<?php echo base_url();?>pages/mapel_per_kelas/getNilaiByKelasAndSiswa.php",
  ...
  function cetak(id){
    ...
    // $.ajax({
    //     type: "POST",
    //     url: '<?php echo base_url();?>pages/siswa/cetak.php',
    //     data: { id_siswa:id }, 
    //     success: function(result){
